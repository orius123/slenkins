...
var orchappApp = angular.module('orchappApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'orchappAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
